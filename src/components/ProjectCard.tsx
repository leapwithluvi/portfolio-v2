...
export const ProjectCard: React.FC<ProjectCardProps> = ({ data }) => {
  ...
  return (
    <motion.div
      ...
      className="group flex flex-col h-full glass rounded-[2rem] overflow-hidden border border-border shadow-sm hover:shadow-2xl transition-all duration-500"
    >
      {/* Image Container */}
        ...
        <div className="mt-auto">
          ...
          <div className="flex items-center gap-4 pt-6 border-t border-border/50">
            <a
              ...
              className="p-3 bg-foreground text-background rounded-full hover:bg-yellow-600 hover:text-white transition-all duration-300 flex items-center justify-center"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 px-6 py-3 border border-border text-foreground rounded-full text-xs font-bold hover:bg-muted transition-all duration-300 flex items-center justify-center gap-2"
            >
              Visit Repository
