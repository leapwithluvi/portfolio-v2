...
export const seo = {
    ...
    keywords: "Luvi Aprilyansyah Gabriel, Fullstack Developer, AI Engineer, ML Engineer, React Developer, Next.js Developer, Node.js, Express.js, Nest.js, Javascript, TypeScript, Python, PostgreSQL, MongoDB, Prisma, Tailwind CSS, Machine Learning, LLM, Ollama, LangChain, Portfolio, leapwithluvi",
